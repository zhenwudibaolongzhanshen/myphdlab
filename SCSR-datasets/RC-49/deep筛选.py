# ============================================================
# Deep Ensemble 样本筛选模块 (PyTorch 实现) - PCA特征数据集版
...
# ==================== 配置 ====================
OUTPUT_DIR = 'deep_ensemble_pca'
RATIO = 0.8942                    # 保留比例（可后续通过加载模型重新计算调整）
N_ENSEMBLE = 5                  # 集成模型数量
...
# ==================== 10. 保存配置信息 ====================
config = {
    'description': 'Deep Ensemble based sample selection (keep low-uncertainty samples) - PCA features',
