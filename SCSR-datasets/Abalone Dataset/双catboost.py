# ============================================================
# catboost_abalone_with_ecoc_filter_catboost.py
# 功能：在鲍鱼数据集上，使用第一阶段ECOC-CatBoost模型概率筛选样本，
#       然后训练CatBoost回归模型。
# 依赖：需先运行第一阶段脚本 ecoc+catboost_cls.py，生成模型文件：
#       ecoc_abalone_with_sex_output_catboost/ecoc_catboost_abalone.pkl
# ============================================================
...
# ==================== 定义与第一阶段完全一致的 ECOCCatBoostTrainer 类 ====================
...
def main():
    print("=" * 80)
    print("ECOC-CatBoost筛选 + CatBoost回归 - 鲍鱼数据集")
    print("=" * 80)

    # 加载第一阶段模型（CatBoost分类器版本）
    ecoc_model_path = r'ecoc_abalone_with_sex_output_catboost/ecoc_catboost_abalone.pkl'
    ...
    output_base_dir = 'catboost_filtered_abalone_catboost'
