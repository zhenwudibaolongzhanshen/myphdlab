# ============================================================
# CatBoost 评估脚本 - 用于 Deep Ensemble 筛选后的鲍鱼数据集
# 功能：读取筛选后的 train_filtered.csv / val_filtered.csv / test_filtered.csv
#       训练 CatBoost 回归模型，输出 RMSE, MAE, R², MAPE, Max APE
# ============================================================
...
# ==================== 配置 ====================
# 请修改为你的 Deep Ensemble 输出目录（包含 train_filtered.csv 等文件）
DATA_DIR = 'deep_ensemble_abalone'   # 例如 'deep_ensemble_abalone'
