# ============================================================
# xgboost_diabetes_with_ecoc_filter.py
# 功能：在糖尿病数据集上，使用ECOC软分类概率筛选样本，
#       然后训练XGBoost回归模型，评估并保存结果。
# 依赖：需先运行 ECOC-MLP 训练脚本，生成模型文件：
#       ecoc_diabetes_output/ecoc_mlp_diabetes.pkl
# ============================================================
...
def condition4_top1_gt(prob, threshold=0.25):
...
def main():
    print("=" * 80)
    print("ECOC筛选 + XGBoost回归 - 糖尿病数据集")
    print("=" * 80)

    # 加载ECOC模型
    ecoc_model_path = r'ecoc_diabetes_output/ecoc_mlp_diabetes.pkl'
    ...
    # 划分数据集（70%训练，20%验证，10%测试，随机种子42）
    ...
    output_base_dir = 'xgboost_filtered_diabetes'
