# ============================================================
# Deep Ensemble 样本筛选模块 (PyTorch 实现)
# 功能：基于 Deep Ensemble (5个独立MLP) 的不确定性对训练/验证/测试集分别筛选 50% 样本
...
# ==================== 配置 ====================
OUTPUT_DIR = 'deep_ensemble_filtered_data'
RATIO = 0.5                    # 保留比例 50%
N_ENSEMBLE = 5                  # 集成模型数量
...
class MLP(nn.Module):
    def __init__(self, input_dim, hidden_layers):
        ...
        for units in hidden_layers:
            ...
            # 这里可以添加 Dropout 作为训练时的正则化，但推理时务必关闭（model.eval()）
            # 为了纯粹集成，也可以不加 Dropout
            prev_dim = units
...
# ==================== 10. 保存配置信息 ====================
config = {
    'description': 'Deep Ensemble based sample selection (keep low-uncertainty samples)',
