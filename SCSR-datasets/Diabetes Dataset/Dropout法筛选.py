# ============================================================
# MC Dropout 样本筛选模块 (PyTorch 实现)
# 功能：基于 MC Dropout 不确定性对训练/验证/测试集分别筛选 50% 样本
...
# ==================== 配置 ====================
OUTPUT_DIR = 'mc_dropout_filtered_data_pytorch'
RATIO = 0.2889                     # 保留比例
...
# ==================== 10. 保存配置信息 ====================
config = {
    'description': 'MC Dropout based sample selection (keep low-uncertainty samples) - PyTorch',
